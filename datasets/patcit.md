...
- rons
- lens
schema_fields: '[''event'', ''hostname'', ''ref'', ''version'', ''subject'', ''md5'',
  ''title'', ''is_referenced_by_count'', ''reference_doi'', ''meeting'', ''publication_number'',
  ''npl_cat_language_flag'', ''PMID'', ''URL'', ''appln_id'', ''type'', ''tdoc_num'',
  ''publication_date'', ''institution'', ''patcit_id'', ''issue'', ''date'', ''bibref_score'',
  ''funder'', ''name'', ''tech'', ''npl_publn_id'', ''page'', ''PMCID'', ''ISSN'',
  ''source'', ''citation'', ''journal_title'', ''body'', ''cited_by'', ''npl_cat'',
  ''item'', ''acc_num'', ''docdb_family_id'', ''ISBN'', ''inpadoc_family_id'', ''author'',
  ''npl_cat_score'', ''tsg'', ''pat_publn_id'', ''DOI'', ''reference_count'', ''language_code'',
  ''wg'', ''is_cited_by_count'', ''hash_id'', ''volume'', ''language_is_reliable'',
  ''abstract'', ''journal_title_abbrev'', ''url'']'
shortname: patcit
